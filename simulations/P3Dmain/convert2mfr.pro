...
;function convert2mfr, MFR_ID, geo_path = geo_path, plt_path = plt_path, out_path = out_path, Ngrids = Ngrids
...
;  print,lines
  ...
  Te_b = reform(data_plt[5,*],lines-2)
...
;  printf, 1, format='(1f)', reform(rho[it,*],Ngrids)
